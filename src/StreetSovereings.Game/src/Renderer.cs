...
using StreetSovereings.Game.objects;
    ...
    public class Game : GameWindow
    {
        ...
        protected override void OnResize(ResizeEventArgs e)
        {
            ...
            var projection = Matrix4.CreatePerspectiveFieldOfView(MathHelper.DegreesToRadians(45.0f),
                e.Width / (float)e.Height, 0.1f, 100.0f);
        ...
        private void RenderGame()
        {
            ...
            {
                var model = Matrix4.CreateTranslation(cube.Position) * Matrix4.CreateRotationY(_rotation) *
                            Matrix4.CreateRotationX(_rotation);
